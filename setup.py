...
__version__ = find_version("marshmallow_factory/__init__.py")
...
setup(
    ...
    url='https://github.com/douglas-treadwell/marshmallow-factory',
    packages=find_packages(exclude=('tests', 'examples', 'docs')),
    package_dir={'marshmallow_factory': 'marshmallow_factory'},
